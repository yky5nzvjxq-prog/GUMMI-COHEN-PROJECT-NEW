...
export default function SettingsPage() {
  ...
  return (
    <div className="p-8 max-w-3xl">
      <h1 className="text-2xl font-bold text-navy-600 mb-6">הגדרות</h1>

      <div className="bg-white rounded-xl shadow-sm p-6 space-y-6">
        <div>
          <h2 className="font-semibold text-navy-600 mb-4">פרטי מפעל</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">שם מנהל האיכות</label>
              <input
                type="text"
        ...
        <div>
          <h2 className="font-semibold text-navy-600 mb-4">ברירות מחדל</h2>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">תוכנית דגימה ברירת מחדל</label>
            <input
              type="text"
        ...
        <div>
          <h2 className="font-semibold text-navy-600 mb-4">חומרים נפוצים</h2>
        ...
        <div className="bg-gray-50 rounded-lg p-4">
          <h3 className="text-sm font-medium text-gray-600 mb-2">אודות המערכת</h3>
        ...
        <button
          onClick={handleSave}
          disabled={saving}
          className="flex items-center gap-2 bg-navy-600 text-white px-6 py-2.5 rounded-lg text-sm font-medium hover:bg-navy-500 disabled:opacity-50 transition-colors"
        >
          <Save size={16} />
